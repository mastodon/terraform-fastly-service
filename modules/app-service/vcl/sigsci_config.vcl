backend F_sigsci_waf {
	...
	.host = "se--mastodon--6421bac5235add25b5353b4d.edgecompute.app";
	.host_header = "se--mastodon--6421bac5235add25b5353b4d.edgecompute.app";
	.max_connections = 200;
	.port = "443";
	.share_key = "9D879RZnDn0WM3L3A3LU43";
	.ssl = true;
	.ssl_cert_hostname = "se--mastodon--6421bac5235add25b5353b4d.edgecompute.app";
	.ssl_check_cert = always;
	.ssl_sni_hostname = "se--mastodon--6421bac5235add25b5353b4d.edgecompute.app";
	.probe = {
		.dummy = false; # this is a real healthcheck for fail open
		.initial = 1;
		.interval = 12s;
		.request = "HEAD / HTTP/1.1" "Host: se--mastodon--6421bac5235add25b5353b4d.edgecompute.app" "Connection: close" "x-sigsci-backend: health check" "x-sigsci-host: host health check";
