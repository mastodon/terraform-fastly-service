...
resource "fastly_service_vcl" "app_service" {
  ...
  dynamic "condition" {
    ...
    content {
      ...
      priority  = 10
      statement = "table.lookup(${replace(var.ja3_blocklist_name, " ", "_")}, tls.client.ja3_md5) == \"block\""
      type      = "REQUEST"
    }
  }
  ...
  # JA4 Blocklist settings
  # Any requests that contain a TLS JA3 in the dictionary is blocked.

  dynamic "dictionary" {
    for_each = var.ja4_blocklist ? [1] : []
    content {
      name = var.ja4_blocklist_name
    }
  }
  ...
  dynamic "condition" {
    for_each = var.ja4_blocklist ? [1] : []
    content {
      name      = "Generated by ${var.ja4_blocklist_name}"
      priority  = 10
  ...
  dynamic "response_object" {
    ...
    content {
      ...
      content_type      = "text/html"
      request_condition = "Generated by ${var.ja4_blocklist_name}"
      response          = "Forbidden"
      status            = 403
    }
  }
